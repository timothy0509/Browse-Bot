...
- 🤖 **Multi-Provider Support**: Integrates with Google Gemini, Mistral AI, MiniMax, OpenAI, Anthropic Claude, xAI Grok, Perplexity AI, Cerebras, and local models via Ollama.
...
| `extension.browse-bot.llm-provider`                                   | String  | `"gemini"`                                                  | Which AI provider to use. Options: `gemini`, `mistral`, `minimax`, `openai`, `claude`, `grok`, `perplexity`, `cerebras`, `ollama`. |
...
| `extension.browse-bot.minimax-api-key`                                | String  | _(empty)_                                                   | Your API key for MiniMax.                                                                                               |
| `extension.browse-bot.minimax-model`                                  | String  | `"MiniMax-M2.1"`                                             | The specific MiniMax model to use.                                                                                      |
